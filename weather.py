...
canvas = Canvas(root, width=529, height=505, bg="black")
canvas.pack()
img = PhotoImage(file="cloudsss.png")
...
mainlabel = Label(root, text=" ", font=("new roman", 30, "bold"),
                  bg="#261935", width=4, relief=GROOVE, bd=0, fg='white')
mainlabel.place(x=270, y=120)

mainlabel1 = Label(root, text=" ", font=("new roman", 15, "bold"),
                   bg="#261935", width=12, relief=GROOVE, bd=0, fg='white')
